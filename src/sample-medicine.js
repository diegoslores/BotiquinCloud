const pills = {
  medicine1: {
    ...
    desc: "Liquido utilizado para la desinfeccion de heridas.",
    fabricante: "Meda",
    image: "/images/betadine.jpg",
    name: "Betadine",
    pacientes: "Pedro Perez,\nMaría Soledad,\nArmando Casitas",
    prescripcion: "Aplicar en la herida con una gasa",
    tipo: "pomada",
    envasesTotales: "1"
  },
  ...
  medicine2: {
    ...
    composicion: "500 mg",
    desc: "Comprimidos recubiertos para el tratamiento de la fiebre.",
    fabricante: "Normon",
    image: "/images/paracetamol.jpg",
    name: "Paracetamol",
    pacientes: "Pedro Perez,\nMaría Soledad,\nArmando Casitas",
    prescripcion: "1 comprimido con cada comida",
    tipo: "comprimido",
    envasesTotales: "3"
  },
  medicine3: {
    ...
    name: "Thrombocid",
    pacientes: "Pedro Perez,\nMaría Soledad,\nArmando Casitas",
    prescripcion: "aplicar sobre la zona 2 veces al día",
    tipo: "pomada",
    envasesTotales: "1"
  },
  medicine4: {
  ...
  medicine5: {
    ...
    desc: "Para la inflamación",
    fabricante: "Normon",
    image: "https://static.laverdad.es/www/multimedia/20181...",
    name: "Ibuprofeno",
    pacientes: "Pedro Perez,\nMaría Soledad,\nArmando Casitas",
    prescripcion: "1 comprimido cada 8 horas",
    tipo: "comprimido",
    envasesTotales: "5"
  }
};
